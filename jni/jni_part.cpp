...
JNIEXPORT void JNICALL Java_org_opencv_samples_tutorial2_Tutorial2Activity_TLDSave(JNIEnv *env,jobject,jstring path)
{
...
JNIEXPORT void JNICALL Java_org_opencv_samples_tutorial2_Tutorial2Activity_TLDLoad(JNIEnv *env,jobject,jstring Path)
{
/*
	if (etld!=NULL)
		{
...
JNIEXPORT void JNICALL Java_org_opencv_samples_tutorial2_Tutorial2Activity_CMTSave(JNIEnv *env,jobject,jstring path)
{
...
JNIEXPORT void JNICALL Java_org_opencv_samples_tutorial2_Tutorial2Activity_CMTLoad(JNIEnv *env,jobject,jstring path)
{
